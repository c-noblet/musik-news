  ...
  <div class="flex flex-1 items-center justify-center">
    <div class="px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full text-center">
      ...
      <div class="text-center mt-12">
        ...
        <NuxtLink to="/login" class="font-light text-md text-primary underline font-semibold hover:text-white">
          Connectez-vous !
        </NuxtLink>
      </div>
    </div>
  ...
  methods: {
    submitForm () {
      this.$store.dispatch('auth/register', {
        ...
        .then((msg) => {
          this.$router.push('/')
          this.$store.dispatch('flashMessage/addSuccessMessage', 'Inscription réussie !')
        })
    }
  }
}
