    ...
    <aside>
      <div class="flex justify-start">
        <div class="w-64 h-screen bg-gray-800 mt-8 sm:mt-0">
            ...
            <nav class="mt-10">
                <NuxtLink to="/admin/news" class="flex items-center py-2 px-8 bg-gray-700 text-gray-100 border-r-4 border-gray-100">
                ...
                <NuxtLink to="/admin/artists" class="flex items-center mt-5 py-2 px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <NuxtLink to="/admin/concerts" class="flex items-center mt-5 py-2 px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <NuxtLink to="/admin/albums" class="flex items-center mt-5 py-2 px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100">
                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <NuxtLink to="/admin/genres" class="flex items-center mt-5 py-2 px-8 text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100">
